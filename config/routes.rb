Rails.application.routes.draw do
  ...
  get "/admin/person/new" to "persons#new", as: 'new_person'
  post "/admin/person" to "persons#create", as: 'create_person'
  get "/admin/person/:id" to "persons#edit", as: 'edit_person'
